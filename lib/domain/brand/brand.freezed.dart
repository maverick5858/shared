...
class _$BrandImpl implements _Brand {
  _$BrandImpl({required this.name, required this.logoUrl});
  ...
  @override
  String toString() {
    return 'Brand(name: $name, logoUrl: $logoUrl)';
  }
...
abstract class _Brand implements Brand {
  factory _Brand({required final String name, required final String logoUrl}) =
      _$BrandImpl;
